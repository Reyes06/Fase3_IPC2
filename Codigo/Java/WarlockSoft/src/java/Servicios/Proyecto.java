...
public class Proyecto{
    ...
    @WebMethod(operationName="agregarMiembrosPorProyecto")
    public boolean agregarMiembrosPorProyecto(@WebParam(name= "id_usuario") int id_usuario,
            @WebParam(name= "id_proyecto") int id_proyecto){
        Conexion conexion = new Conexion();
        try {
            return conexion.agregarMiembrosPorProyecto(id_usuario, id_proyecto);
        } catch (SQLException ex) {
            Logger.getLogger(Proyecto.class.getName()).log(Level.SEVERE, null, ex);
            return false;
        }
    ...
    @WebMethod(operationName="obtenerMiembrosParticipantesPorProyecto")
    public String[] obtenerMiembrosParticipantesPorProyecto(@WebParam(name= "id_proyecto") int id_proyecto){
        Conexion conexion = new Conexion();
        try {
            return conexion.obtenerMiembrosParticipantesPorProyecto(id_proyecto);
        } catch (SQLException ex) {
            Logger.getLogger(Proyecto.class.getName()).log(Level.SEVERE, null, ex);
            return null;
        }
    ...
    @WebMethod(operationName="obtenerMiembrosInscritosPorProyecto")
    public String[] obtenerMiembrosInscritosPorProyecto(@WebParam(name= "id_proyecto") int id_proyecto){
        Conexion conexion = new Conexion();
        try {
            return conexion.obtenerMiembrosInscritosPorProyecto(id_proyecto);
        } catch (SQLException ex) {
            Logger.getLogger(Proyecto.class.getName()).log(Level.SEVERE, null, ex);
            return null;
        }
    ...
    @WebMethod(operationName="elegirParticipanteProyecto")
    public boolean elegirParticipanteProyecto(@WebParam(name= "id_usuario") int id_usuario, 
            @WebParam(name= "id_proyecto") int id_proyecto){
        Conexion conexion = new Conexion();
        try {
            return conexion.elegirParticipanteProyecto(id_usuario, id_proyecto);
        } catch (SQLException ex) {
            Logger.getLogger(Proyecto.class.getName()).log(Level.SEVERE, null, ex);
            return false;
        }
